                                        ...
                                        <div class="card-header card-no-border" >
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <form method="POST" action="<?php echo e(url('store/bank')); ?>">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/first-ally-test/resources/views/Dashboard/Bank/create.blade.php ENDPATH**/ ?>