                                        ...
                                        <div class="card-header card-no-border" >
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <form method="POST" action="<?php echo e(url('transfer/cash')); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="form-group">
                                                            <label>Amount</label>
                                                           <input type="number" step="0.01" name="amount" value="<?php echo e($fetchRequest->conversion_rate); ?>" class="form-control" readonly/>
                                                            <input type="hidden" name="userId" value="<?php echo e($fetchRequest->user['id']); ?>"/>
                                                            <input type="hidden" name="tranxId" value="<?php echo e($fetchRequest->id); ?>"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Prefered Currency</label>
                                                          <input type="text" value="<?php echo e($fetchRequest->currency_conversion); ?>" name="currency" class="form-control" readonly/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Select Users Bank</label>
                                                            <select class="form-control"  name="bank">
                                                                   <option value="">Select  Option</option>
                                                                <?php $__currentLoopData = $usersBank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($bank->account_number); ?>"><?php echo e($bank->bank_name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                                            </select>
                                                        </div>
                                                        <button class="btn btn-success">Pay <?php echo e($fetchRequest->user['name']); ?></button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/first-ally-test/resources/views/Dashboard/Request-exchange/transfer.blade.php ENDPATH**/ ?>