                                        ...
                                        <div class="card-header card-no-border" >
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <form method="POST" action="<?php echo e(url('store/rate')); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="form-group">
                                                            <label>Currency</label>
                                                            <input type="text" name="currency" class="form-control" placeholder="Dollar /Pounds/Euros"/>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Rate</label>
                                                            <input type="number" step="0.01" name="rates" class="form-control"/>
                                                        </div>
                                                        <input type="hidden" name="naira" value="1"/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/first-ally-test/resources/views/Dashboard/Rates/create.blade.php ENDPATH**/ ?>