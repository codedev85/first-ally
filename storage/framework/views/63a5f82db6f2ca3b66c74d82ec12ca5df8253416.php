<?php $__env->startSection('title' ,'Request Exchange'); ?>
                ...
                <script id="result-template" type="text/x-handlebars-template">
                    <div class="ProfileCard u-cf">
                        ...
                        <div class="ProfileCard-details">
                            <div class="ProfileCard-realName">gggg</div>
                        </div>
                    </div>
                </script>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Request Exchange</li>
                                </ol>
                            </div>
                            <div class="col-6">
                                <!-- Bookmark Start-->
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    ...
                                                    <div style="display:flex; justify-content: center;">
                                                        ...
                                                        <div>
                                                            <img src="<?php echo e(asset('/pay-img/pay-option.png')); ?>"/>
                                                        </div>

                                                    </div>
                                                    <div style="display:flex;flex-direction:column;">
                                                       <p style="font-size:20px;" class="text-danger">  You are about to exchange  &#x20A6;  <?php echo e(number_format($sessionAmount)); ?> @ the rate of <?php echo e($currentRate->rates); ?> <?php echo e($currentRate->currency); ?></p>
                                                        <p style="font-size:18px;" class="text-success">A cashback value of <?php echo e(number_format($sessionAmount / $currentRate->rates )); ?> <?php echo e($currentRate->currency); ?> will be credited to your <?php echo e($sessionCashBackOption); ?> ...... </p>
                                                    </div>
                                                    <?php
                                                    $conversionRate = $sessionAmount / $currentRate->rates;
                                                    $conversionCurrency = $currentRate->currency;
                                                    ?>
                                                      ...
                                                      <form method="POST" action="<?php echo e(route('pay')); ?>" accept-charset="UTF-8" class="form-horizontal" role="form">
                                                          <div class="row" >
                                                              <div class="col-md-12 col-md-offset-2">
                                                                  ...
                                                                  <input type="hidden" name="amount" value="<?php echo e($sessionAmount *100); ?>"> 
                                                                  <input type="hidden" name="quantity" value="1">
                                                                  <input type="hidden" name="currency" value="NGN">
                                                                  <input type="hidden" name="metadata" value="<?php echo e(json_encode($array = ['user_id' => auth()->user()->id ,'cRate'=> $conversionRate ,'cCurrency'=>$conversionCurrency ])); ?>" > 
                                                  ...
                                                  <div style="justify-content: center;">
                                                      <button class="btn btn-danger btn-lg btn-block">Cancel Payment</button>
                                                  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/first-ally-test/resources/views/Dashboard/Request-exchange/payment.blade.php ENDPATH**/ ?>