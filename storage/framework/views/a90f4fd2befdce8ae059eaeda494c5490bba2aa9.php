                                                        ...
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item">
                                                                <div style="display:flex;justify-content: space-between">
                                                                    ...
                                                                    <div>
                                                                        <button class="btn btn-info">Mark as Default</button>
                                                                        <button class="btn btn-success">Update</button>
                                                                    </div>
                                                                </div>

                                                            </li>
                                                            <li class="list-group-item"><?php echo e($bank->account_name); ?></li>
                                                            <li class="list-group-item"><?php echo e($bank->account_number); ?></li>
                                                        </ul>
                                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/first-ally-test/resources/views/Dashboard/Bank/list.blade.php ENDPATH**/ ?>