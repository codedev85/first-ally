                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <?php $__currentLoopData = $exchangeRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <?php if(auth()->user()->role_id != 2): ?>
                                                                <td>
                                                                    <a href="<?php echo e(url('/transfer/cash-to-bank/'.$exRequest->id)); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/first-ally-test/resources/views/Dashboard/Request-exchange/credit.blade.php ENDPATH**/ ?>