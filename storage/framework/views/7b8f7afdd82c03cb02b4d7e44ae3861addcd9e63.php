                                        ...
                                        <div class="card-header card-no-border" >
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <form method="POST" action="<?php echo e(url('send/request/exchange')); ?>">
                                                        <?php echo csrf_field(); ?>
                                                           ...
                                                           <select class="form-control"  name="currency">
                                                               <option value="">Select Exchange Currency</option>
                                                                  <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                   <option value="<?php echo e($currency->currency); ?>"><?php echo e($currency->currency); ?> (<?php echo e($currency->rates); ?>)</option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control"  name="recipient">
                                                                   <option value="">Select Cash-Back Option</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/first-ally-test/resources/views/Dashboard/Request-exchange/request.blade.php ENDPATH**/ ?>